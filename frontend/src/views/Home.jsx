...
import bg from '../public/assets/Landing_image.avif';
  ...
  return (
    <main className="home-container">
      ...
      <section className="hero-section"
        style={{
          backgroundImage: `linear-gradient(rgba(18,60,98,0.6), rgba(18,60,98,0.8)), url(${bg})`
        }}>
        <div className="hero-bg">
          <div className="hero-content">
            <h1>Laboratorio de Diseño y Fabricación Digital</h1>
            <h2>Innovación tecnológica aplicada a la salud en La Rioja</h2>
          </div>
        </div>
      </section>
      ...
      <section id="quienes-somos" className="section">
        <div className="section-content">
          ...
          <p>
            El Laboratorio de Diseño y Fabricación Digital para el área de Ciencias Médicas en la Provincia de La Rioja
            surge como una iniciativa conjunta de la Universidad Nacional de La Rioja (UNLaR) y el Estado provincial en el
            marco de los Proyectos Federales de Innovación 2022 (PFI 2022). Nuestro objetivo es incorporar la tecnología de
            la impresión 3D a la educación superior y a la práctica clínica, brindando un espacio especializado para el desarrollo
            de modelos anatómicos, prototipos médicos y soluciones biomédicas personalizadas.
          </p>
          <p>
            Actualmente, el laboratorio funciona en una sede provisoria dentro del CENIIT, con capacidad operativa para producir
            cartelería institucional, modelos anatómicos y prototipos experimentales. Nuestra sede definitiva será el Hospital
            de Clínicas Virgen de Fátima, donde contaremos con espacios especializados para la impresión, el postprocesado y
